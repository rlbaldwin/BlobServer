...
BlobProvider = function () {
    ...
    this.createContainer = function createContainer(container) {
    ...
    this.uploadBlobs = function uploadBlobs(sourceDirectoryPath, container, callback) {
        // Step 0 : validate directory is valid.
        if (!fs.existsSync(sourceDirectoryPath)) {
            console.log(sourceDirectoryPath + ' is an invalid directory path.');
        } else {
    ...
    this.listFilesUpload = function listFilesUpload(sourceDirectoryPath, container, callback) {
    ...
    this.uploadFilesParallel = function uploadFilesParallel(files, container, callback) {
        var finished = 0;
    ...
    this.downloadBlobs = function downloadBlobs(container, destinationDirectoryPath, callback) {
        var fs = require('fs');
    ...
    this.downloadFilesParallel = function downloadFilesParallel(container, destinationDirectoryPath, callback) {
    ...
    this.requestAccessConditionSample = function requestAccessConditionSample(container) {
    ...
    this.downloadBlobProperties = function downloadBlobProperties(container, blobName) {
    ...
    this.testAccess = function testAccess(container, blobName, etag) {
